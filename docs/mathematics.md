...
Cocycle's engineering conventions. See [references](references.md) for primary
sources and [testing](testing.md) for independent checks.
...
distance; compare [B21 §2](references.md#b21). A face uses a subset of the vertex
...
See [ZC05](references.md#zc05) for the algebraic background.
...
this pairing theorem: the direct source is [B21 Proposition 3.1 and Algorithm 1](references.md#b21).
...
[B21 §4](references.md#b21) for the H0 algorithm context.
...
[A20 Definition 3.1](references.md#a20) uses base-two logarithms. Cocycle explicitly
...
by [CSO13 Theorem 5.2](references.md#cso13). Bottleneck distance $d_B$ allows
...
[CSO13 Theorem 2.3](references.md#cso13) yields $d_B\le\varepsilon$.
...
have separate conditions; see [B21 §§3.2–3.5 and §4](references.md#b21).
