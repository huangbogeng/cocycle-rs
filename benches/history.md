...
An earlier, unpinned Rust-only run is retained in [linux-x86_64.csv](linux-x86_64.csv).
...
Current test obligations live in [testing](../docs/testing.md); new cleanup checks
