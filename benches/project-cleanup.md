...
[same-size benchmark](scaling-threeway.md). It does not claim new performance
...
No hosted CI or publication has been performed. Real repository metadata and the
first hosted CI run remain prerequisites for release, rather than placeholder URLs
or an unverified success badge.
