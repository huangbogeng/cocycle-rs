# Scaling and difficult inputs: 2026-09-17
...
[same-size comparison](scaling-threeway.md) schedules GUDHI at every size. Original
...
the older 16-level baseline. Timed API boundaries follow the [protocol](python-protocol.md).
